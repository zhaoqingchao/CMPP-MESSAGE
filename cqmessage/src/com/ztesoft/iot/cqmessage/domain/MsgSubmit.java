...
import com.ztesoft.iot.cqmessage.util.MsgUtils;
...
//	private static Logger logger=Logger.getLogger(MsgSubmit.class);
	...
	private String linkID = "01234567890123456789";
	...
	public byte[] toByteArry(){
		...
		try {
			...
			msid[6] = 0x00;
			msid[7] = 0x01;
			//MsgUtils.writeString(dous,this.msgId,8);//Msg_Id 信息标识，由SP接入的短信网关本身产生，本处填空
			dous.write(msid);
